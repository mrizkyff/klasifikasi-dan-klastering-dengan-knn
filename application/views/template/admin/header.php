...
<head>
  ...
  <title>DNRepository IT Department | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url() ?>asset/plugins/fontawesome-freeWEB/css/all.min.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3" action="<?php echo base_url().'index.php/skripsi/search'?>" method="post">
      <div class="input-group input-group-sm">
        <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" name="query" value="<?php echo $pencarian?>">
